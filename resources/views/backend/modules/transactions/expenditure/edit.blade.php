        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <select class="form-control demo-select2-placeholder" name="work_type">
                    ...
                    <option value="service" @if($data->work_type == 'service') selected @endif>Service</option>

                    <option value="purchase" @if($data->work_type == 'purchase') selected @endif>Purchase</option>
