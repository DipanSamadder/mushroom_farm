...
@endphp
 ...
 <div class="row clearfix">
    ...
    @if(dsld_check_permission(['add-designations']))
            ...
            <div class="body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form id="add_new_form" action="{{ route('designations.store') }}" method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control show-tick ms select2" name="parent">

                                                <option value="0">Select Parent</option>

                                                @if(App\Models\Designation::where('level', 1)->get() != '')

                                                    @foreach(App\Models\Designation::where('level', 1)->get() as $key => $value)
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control show-tick ms select2" name="level">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label class="form-label">Is Temporary ?<small class="text-danger">*</small></label>        
                                            <select class="form-control show-tick ms select2" name="is_temporary">
...
<script src="{{ dsld_static_asset('backend/assets/js/pages/forms/advanced-form-elements.js') }}"></script>
    ...
    <div class="modal fade" id="edit_larger_modals" tabindex="-1" role="dialog">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <form id="update_form" action="{{ route('designations.update') }}" method="POST" enctype="multipart/form-data" >
    ...
    <input type="hidden" name="get_pages" id="get_pages" value="{{ route('ajax_designations') }}">
