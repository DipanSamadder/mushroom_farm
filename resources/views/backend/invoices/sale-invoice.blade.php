  ...
  <body>
    <header class="clearfix">
      ...
      <div id="company" class="clearfix">
        ...
        <div>4555,<br /> Address</div>
        <div>(602) XXX-XXX</div>
        <div><a href="mailto:company@example.com">example@example.com</a></div>
      </div>
      <div id="project">
        <div><span>PROJECT</span> Website development</div>
        <div><span>CLIENT</span> Example</div>
        <div><span>ADDRESS</span> XXXXXX</div>
        <div><span>EMAIL</span> <a href="mailto:example@example.com">example@example.com</a></div>
        <div><span>DATE</span> August 17, 2024</div>
