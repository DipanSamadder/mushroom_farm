...
<div class="container-fluid g-0">
    ...
    <div class="col-md-9">
        ...
        <div class="row p-0 mt-5">
            <div class="col-md-8">
                <div class="contente">
                    <div class="divimdlogo">
                        <img src="{{ dsld_uploaded_file_path(dsld_page_meta_value_by_meta_key('logophilosophy_logophilosophy_file_1', $page->id)) }}">
                    </div>
                    <div class="contenelo">
                        <h2>{{ dsld_page_meta_value_by_meta_key('logophilosophy_logophilosophy_text_0', $page->id) }}</h2>
                    </div>
