...
class PaymentModeController extends Controller
{
    ...
    function __construct(TypeInterfaces $type){
        ...
        $this->typeIn = $type;
        $this->middleware('permission:payment_mode', ['only' => ['index','get_ajax_payment_mode']]);
        $this->middleware('permission:add-payment_mode', ['only' => ['create','store']]);
        $this->middleware('permission:edit-payment_mode', ['only' => ['edit','update']]);
        $this->middleware('permission:delete-payment_mode', ['only' => ['destroy']]);
