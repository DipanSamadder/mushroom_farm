...
@endphp
 ...
 <div class="row clearfix">
    @if(dsld_check_permission(['add-payment-mode']))
    <div class="col-lg-8">
    @else
    <div class="col-lg-12">
    @endif
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <div class="body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_new_form" action="{{ route('payment_mode.store') }}" method="POST" enctype="multipart/form-data" >
                            <input type="hidden" name="created_by" value="{{ Auth::user()->id }}">
                            <input type="hidden" name="type" value="payment_mode">
...
@section('footer')
    ...
    <div class="modal fade" id="edit_larger_modals" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="update_form" action="{{ route('payment_mode.update') }}" method="POST" enctype="multipart/form-data" >
    ...
    <input type="hidden" name="get_pages" id="get_pages" value="{{ route('ajax_payment_mode') }}">
