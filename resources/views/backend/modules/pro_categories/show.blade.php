...
@endphp
 ...
 <div class="row clearfix">
    ...
    @if(dsld_check_permission(['add-pro_categorie']))
            ...
            <div class="body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form id="add_new_form" action="{{ route('pro_categorie.store') }}" method="POST" enctype="multipart/form-data" >
...
@section('footer')
    ...
    <div class="modal fade" id="edit_larger_modals" tabindex="-1" role="dialog">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <form id="update_form" action="{{ route('pro_categorie.update') }}" method="POST" enctype="multipart/form-data" >
    ...
    <input type="hidden" name="get_pages" id="get_pages" value="{{ route('ajax_pro_categorie') }}">
