...
@section('content')
 ...
 <div class="row clearfix">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2><strong>All</strong> Vendor </h2>

            </div>
            <div class="body">
                <div class="row">
                <div class="col-lg-6">
                    @if(dsld_check_permission(['add-vendor']))
...
@section('footer')
    @include('backend.modules.vendors.add')
    <input type="hidden" name="page_no" id="page_no" value="1">
<script>
    function add_new_lg_modal_form(){
        $('#add_new_larger_modals').modal('show');
        $('#add_new_larger_modals_tile').text('Add New Vendor');
    }
