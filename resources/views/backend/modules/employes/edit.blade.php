...
@section('content')
 ...
 <form id="update_form" action="{{ route('employes.update') }}" method="POST" enctype="multipart/form-data" >
                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8">
                            ...
                            <input type="number" name="aadhar" id="aadhar" class="form-control" placeholder="Aadhaar Card" onchange="is_edited()" value="{{ @$data->employe->aadhar }}" />
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8">
                            ...
                            <input type="text" name="father" id="father" class="form-control" placeholder="Father's Name" onchange="is_edited()" value="{{ @$data->employe->father }}" />
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8">
                            ...
                            <textarea name="remark" id="remark" class="form-control" placeholder="Remark" onchange="is_edited()">{{ @$data->employe->remark }}</textarea>
